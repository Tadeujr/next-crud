...
export default function Tabela(props: TabelaProsps) {
  ...
  function rederizarCabecalho() {
    return (
      <tr>
        ...
        {exibirAçoes ? <th className="p-4">Ações</th> : false}
      </tr>
    );
  }
    ...
    return props.clientes?.map((cliente, i) => {
      return (
        ...
        >
          ...
          {exibirAçoes ? rederizarAções(cliente): false}
        </tr>
      );
    });
  }

  function rederizarAções(cliente: Cliente) {
    return (
